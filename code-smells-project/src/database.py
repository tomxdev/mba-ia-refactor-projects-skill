"""Fábrica de conexão + criação de schema + seed inicial.

A conexão é criada no composition root (app.py) e injetada nos models.
Não há mais singleton global mutável.
"""
import sqlite3
